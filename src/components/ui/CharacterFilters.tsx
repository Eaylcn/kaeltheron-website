    ...
    <div className="bg-[#1C2B4B] backdrop-blur-sm rounded-xl p-6">
      ...
      <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 ${selectedType ? 'mb-6' : ''}`}>
        ...
        <select
          ...
          className="bg-[#162137] rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-amber-500"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-[#162137] rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-amber-500"
            >
